...
overwrite = false;
plot_figure = false;
save_rasters = true; % saves the rasters for Sam, skips the analysis. 

if single_unit
    if lbhb
        recording_ids = {'CRD004a14_p_NTI', 'CRD019b15_p_NTI', 'ARM017a05_p_NTI'...
            'ARM019a12_p_NTI', 'AMT031a13_p_NTI', 'ARM021b04_p_NTI'...
            'ARM027a05_p_NTI', 'AMT029a16_p_NTI', 'CRD011c12_p_NTI'...
            'ARM020a09_p_NTI', 'ARM022b05_p_NTI', 'AMT032a11_p_NTI'...
            'CRD005b12_p_NTI', 'AMT030a12_p_NTI', 'CRD018d15_p_NTI'...
            'ARM025a05_p_NTI', 'ARM032a10_p_NTI', 'ARM018a08_p_NTI'...
            'ARM026b10_p_NTI', 'ARM033a12_p_NTI', 'AMT028b05_p_NTI'...
            'DRX021a19_p_NTI', 'ARM031a09_p_NTI', 'ARM024a05_p_NTI'...
            'DRX023a22_p_NTI', 'ARM029a06_p_NTI', 'CRD003b14_p_NTI'...
            'ARM028b04_p_NTI', 'CRD012b19_p_NTI', 'DRX010c05_p_NTI'...
            'CRD014b10_p_NTI', 'ARM023a04_a_NTI', 'AMT026a14_p_NTI'};
...
for i = 1:length(recording_ids)
    try
        ...
        msg = sprintf('bad recording: %s', recording_ids{i});
        disp(msg)
    end
end